...
class Positioner:
    ...
    def setSensorVoltage(self,voltage): ##added by Itai Silber 25.05.2022
        '''
        Sets the voltage applied to position sensor, for RES only. Default axes is 0
        '''
    ...
    def setTargetGround(self,axisNo,enable): ##New
        '''
        Sets if an axisNo will grouned once acheived target.
