"""
Dynacool Measurement Procedures - Main Entry Point

This module provides the GUI launcher for Dynacool measurement procedures.
...
class Launcher(QtWidgets.QMainWindow):
    ...
    def closeEvent(self, event):
        ...
        try:
            ...
            # Dynacool PPMS client has a disconnect() method, not an adapter.
            if getattr(cfg, "magnet", None) is not None:
                try:
                    cfg.magnet.disconnect()
                except Exception:
                    pass
