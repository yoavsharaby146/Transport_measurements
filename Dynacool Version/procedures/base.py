...
# Dynacool exposes only the sample/platform temperature over MultiPyVu;
# the ICE multi-stage columns (50K/4K/VTI/probe) collapse to a single column.
# Dual_gate (SMUa/SMUb) and MFLI columns disabled by request.
BASE_DATA_COLUMNS = [
    'time(s)',
    'sample_temp(K)',
