...
class Differential_Resistance_SRS860(DynacoolProcedure):
    # --- Parameters ---
    ...
    def getmeas(self, t0):
        ...
        aux = getattr(SRS860_1, f'dac{self.aux_signal}') if (self.use_srs860_1 and base._is_connected(SRS860_1)) else math.nan
