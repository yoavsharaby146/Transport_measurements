"""
Resistance magnet and 2-gate mapping measurement procedure.
"""
...
class Resistance_magnet_and_2gate_mapping_measurement(Procedure):
    ...
    smu_1 = ListParameter('Top Gate SMU', default='Gate_1', choices=['Gate_1', 'Gate_2', 'smua', 'smub'],
                          group_by='mapping', group_condition=True)
    ...
    smu_2 = ListParameter('Bottom Gate SMU', default='Gate_2', choices=['Gate_1', 'Gate_2', 'smua', 'smub'],
                          group_by='mapping', group_condition=True)
    ...
    def getmeas(self, t0):
        if self.use_magnet_dilution:
            dilution.read_magnet()  # Trigger read
