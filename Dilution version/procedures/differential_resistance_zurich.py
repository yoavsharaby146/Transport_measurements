"""
Differential resistance measurement using Zurich MFLI AUX.
"""
...
class Differential_Resistance_Zurich(Procedure):
    ...
    scan_mode = ListParameter('Sweep Mode', choices=['Sweep to setpoint', 'Sweep and Return'], default='Sweep to setpoint')
