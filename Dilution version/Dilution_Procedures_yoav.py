"""
Main entry point for Dilution measurement procedures.

This file imports all procedures from the procedures/ package and provides
the Launcher GUI for running measurements.
"""
...
# Import procedures package
from procedures import (
    PROCEDURES, CATAGORIES,
    save_dir, log, dilution, MFLI_1, MFLI_2, MFLI_3,
...
class Launcher(QtWidgets.QMainWindow):
    ...
    def closeEvent(self, event):
        ...
        try:
            import configuration_Dilution as cfg
            instrument_list = [
...
if __name__ == "__main__":
    from config_prelaunch_Dilution import run_and_optionally_launch
