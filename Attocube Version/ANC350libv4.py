...
setSensorVoltage = getattr(anc350v4,"ANC_setSensorVoltage") ##new
setTargetGround = getattr(anc350v4,"ANC_setTargetGround") ##new
...
getSensorVoltage = getattr(anc350v4,"ANC_getSensorVoltage") ##new
...
setTargetGround.errcheck = checkError ##new
...
getSensorVoltage.errcheck = checkError ##new
setSensorVoltage.errcheck = checkError ##new
