...
from procedures.base import (
    ICEProcedure, _rebuild_all_columns, _rebuild_procedure_columns,
)

base.read_temperature = lambda: [0.0, 0.0, 0.0, 0.0]

# All connected
base.magnet = _MockInst()
base.Dual_gate = _MockDualGate()
...
_USE_NAMES = [
    "use_magnet", "use_dual_gate", "use_keithley_1", "use_keithley_2",
    "use_srs860_1", "use_srs860_2", "use_srs830_1", "use_srs830_2", "use_srs830_3",
    "use_MFLI_1", "use_MFLI_2", "use_MFLI_3",
]


class _DummyProc(ICEProcedure):
    _MID_COLUMNS = []
    _LOCKIN_COL_TYPE = "voltage"


class _DummyProcMid(ICEProcedure):
    _MID_COLUMNS = ["AUX_DC_offset(V)"]
    _LOCKIN_COL_TYPE = "voltage"


class _DummyProcCurrent(ICEProcedure):
