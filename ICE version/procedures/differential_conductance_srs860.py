...
class Differential_conductance_SRS860(Procedure):
    ...
    scan_mode = ListParameter('Scan Mode', default='Sweep and Return',
                              ...
                              group_by='use_srs860_1', group_condition=True)

    dc_offset_setpoint = FloatParameter('Target Setpoint (V)', group_by='use_srs860_1', default=0.1)
    dc_offset_step = FloatParameter('DC Step Size (mV)', group_by='use_srs860_1', default=1)
    ...
    def getmeas(self, t0):
        ...
        vals.append(SRS860_1.dc_offset if self.use_srs860_1 else math.nan)

        for use, inst in [(self.use_srs860_1, SRS860_1), (self.use_srs860_2, SRS860_2)]:
